    ...
    return (
        <Scroll html style={{ width: '100vw' }}>
            ...
            <div style={{ width: '100vw', height: '100vh', padding: '40px', display: 'flex', flexDirection: 'column', pointerEvents: 'none' }}>
                <div className="hero-container" style={{ position: 'absolute', top: '15%', left: '10%', maxWidth: '400px' }}>
                    <h1 className="hero-title" style={{ fontSize: '5rem', fontWeight: 900, lineHeight: 1, letterSpacing: '-2px', textTransform: 'uppercase', color: '#fff', margin: 0 }}>RED BULL</h1>
                    <h2 className="hero-subtitle" style={{ fontSize: '1.5rem', fontWeight: 900, color: '#ff2800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '40px', margin: 0 }}>RACING</h2>
            ...
            <div className="panel-container" style={{ position: 'absolute', top: '100vh', right: '5vw', width: '45vw', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', pointerEvents: 'none' }}>
                <motion.div
                ...
                >
                    ...
                    <h2 className="panel-title" style={{ fontSize: '4rem', fontWeight: 900, marginBottom: '20px', textTransform: 'uppercase', lineHeight: 0.9, color: '#fff' }}>
                    ...
                    <div className="panel-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            ...
            <div className="panel-container" style={{ position: 'absolute', top: '200vh', left: '5vw', width: '45vw', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', pointerEvents: 'none' }}>
                <motion.div
                    initial={{ opacity: 0, filter: 'blur(10px)', x: -50 }}
                    whileInView={{ opacity: 1, filter: 'blur(0px)', x: 0 }}
                    transition={{ duration: 1 }}
