        ...
        <div style={{ width: '100vw', height: '100vh', background: '#030303', color: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
            ...
            >
                <div style={{ flex: 1 }}>
                    ...
                    <h1 style={{ fontSize: '5rem', fontWeight: 900, textTransform: 'uppercase', lineHeight: 0.9, marginBottom: '20px', letterSpacing: '-2px' }}>HONDA<br /><span style={{ color: 'transparent', WebkitTextStroke: '2px #fff' }}>RA620H</span></h1>
                ...
                <div style={{ flex: 1, height: '400px', background: 'radial-gradient(circle, rgba(0,85,255,0.2) 0%, rgba(3,3,3,1) 70%)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
